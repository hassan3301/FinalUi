...
public class SpeakerMessageDialog extends AppCompatDialogFragment {
    private Button btn;
    ...
    public SpeakerMessageDialog(Global global){
        this.global=global;
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        title.setText("Message All Speakers");
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (!message.isEmpty()) {
                    global.getTc().getOC().sendToAllSpeakers(message);
                    //TODO: Fix snackbar
