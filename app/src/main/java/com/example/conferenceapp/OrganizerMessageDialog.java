...
public class OrganizerMessageDialog extends AppCompatDialogFragment {
    private Button btn;
    ...
    public OrganizerMessageDialog(Global global){
        this.global=global;
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        TextView title = (TextView) sendPopup.findViewById(R.id.add_messagedialog_title);
        title.setText("Message All Organizers");
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (!message.isEmpty()) {
                    global.getTc().getOC().sendToAllOrganizers(message);
                    //TODO: Fix snackbar
