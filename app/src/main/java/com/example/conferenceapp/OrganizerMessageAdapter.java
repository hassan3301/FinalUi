...
public class OrganizerMessageAdapter extends RecyclerView.Adapter<OrganizerMessageAdapter.MyViewHolder> {
    ...
    public OrganizerMessageAdapter(Context ct, ArrayList<String> s1, Global global, String from){
        this.s1 = s1;
        this.context = ct;
        this.global = global;
        s = UserAccount.getUnToOrganizer().get(global.getUn());
        this.from = from;
