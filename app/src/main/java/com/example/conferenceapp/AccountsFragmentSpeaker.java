...
public class AccountsFragmentSpeaker extends Fragment {
    ...
    public AccountsFragmentSpeaker(Global global){
        this.global = global;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<User> AccountArrayList = new ArrayList<User>(UserAccount.getUnToSpeaker().values());
    ...
    public void openDialog() {
        SpeakerAddDialog sad = new SpeakerAddDialog(global, new SpeakerAddDialog.DialogCallback() {
            @Override
            public void onDialogCallback() {
                System.out.println("CALLBACK");
                adapter.updateData(getAccountList(new ArrayList<>(UserAccount.getUnToSpeaker().values())));

            }
        });
        sad.show(getChildFragmentManager(), "speakeradd dialog");


    }

    public void openMessageDialog(){
        SpeakerMessageDialog smd = new SpeakerMessageDialog(global);
        smd.show(getChildFragmentManager(), "speakeradd dialog");
    }
