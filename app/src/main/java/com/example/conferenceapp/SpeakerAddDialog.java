...
public class SpeakerAddDialog extends AppCompatDialogFragment {
    private Button btn;
    ...
    public SpeakerAddDialog(Global global, DialogCallback callback){
        this.global=global;
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (!attendeename.isEmpty() && !attendeeusername.isEmpty() && !attendeepassword.isEmpty()) {
                    global.getTc().getOC().createAccount("Speaker", attendeeusername, attendeepassword);
                    //TODO: Fix snackbar
