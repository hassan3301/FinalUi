...
import UseCase.AttendeesAccount;
import Presenters.CommonPrintsPresenter;
import Entities.Event;
import UseCase.EventManager;
import UseCase.OrganizerAccount;
import UseCase.SpeakerAccount;
import UseCase.UserAccount;
import UseCase.VIPAttendeeAccount;
...
public class UserController {
     ...
     * @return
     */
    public String viewScheduledEventsAttending(String username){
        return getUserAccount(username).seeScheduledEvents(username);
